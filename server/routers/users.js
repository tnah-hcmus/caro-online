...
.post(async (req, res) => { //POST: tạo user mới
    // Create a new user
    try {
...
.get(auth, async(req, res) => {//GET: lấy danh sách user (phục vụ admin)
...
.put(auth, async(req, res) => {//PUT: update 1 thuộc tính nào đó cho list user
    //check quyền admin
})
.delete(auth, async(req, res) => {//DELETE: xoá tất cả user
